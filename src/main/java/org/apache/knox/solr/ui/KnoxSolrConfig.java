...
public class KnoxSolrConfig {
   ...
   * Set the solrContext.
   * 
   * @param solrContext the solrContext to set.
   */
   ...
   * Set the knoxContext.
   * 
   * @param knoxContext the knoxContext to set.
   */
   ...
   * 
   * @param knoxTopology the knoxTopology to set.
   */
   ...
   * Get the solrFormat.
   * 
   * @return the solrFormat.
   */
  public String getSolrFormat() {
    return solrFormat;
  }
   ...
   * Set the solrFormat.
   * 
   * @param solrFormat the solrFormat to set.
   */
  public void setSolrFormat(String solrFormat) {
